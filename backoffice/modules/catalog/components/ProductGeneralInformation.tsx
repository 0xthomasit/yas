    ...
    <>
      ...
      <NumberFormatInput
        ...
        registerOptions={{
          ...
          validate: { positive: (v) => Number(v) > 0 || 'Price must be greater than 0' },
        }}
      />
      ...
      <Input
        ...
        registerOptions={{
          ...
          validate: { positive: (v) => Number(v) > 0 || 'Weight must be greater than 0' },
        }}
      />
      ...
      <Input
        ...
        registerOptions={{
          ...
          validate: {
            positive: (v) => Number(v) > 0 || 'Length must be greater than 0',
            greaterThanWidth: (v) => (width && Number(v) > width) || 'Length must be greater than width',
          },
        }}
      />
      ...
      <Input
        ...
        registerOptions={{
          ...
          validate: { positive: (v) => Number(v) > 0 || 'Width must be greater than 0' },
        }}
      />
      ...
      <Input
        ...
        registerOptions={{
          ...
          validate: { positive: (v) => Number(v) > 0 || 'Height must be greater than 0' },
        }}
      />
